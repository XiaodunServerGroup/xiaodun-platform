...
EMAIL_HOST_USER = AUTH_TOKENS.get('EMAIL_HOST_USER', 'xiaodun_dev')  # django default is ''
EMAIL_HOST_PASSWORD = AUTH_TOKENS.get('EMAIL_HOST_PASSWORD', 'Xiaodun')  # django default is ''
